    ...
    <div class="continer">
      <div class="row">
        ...
        <div class="col-sm-7">
          <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="item active">
                <img src="images/Deluxe/delux_img1.jpg" class="thumbnail" alt="img1">
              </div>

              <div class="item">
                <img src="images/Deluxe/delux_img2.jpg" class="thumbnail" alt="im2">
              </div>

              <div class="item">
                <img src="images/Deluxe/delux_img3.jpg" class="thumbnail" alt="im3">
              </div>

              <div class="item">
                <img src="images/Deluxe/delux_img4.jpg" class="thumbnail" alt="img4">
              </div>

              <div class="item">
                <img src="images/Deluxe/delux_img5.jpg" class="thumbnail" alt="img5">
              </div>
            </div>
          ...
          <h2 class="Ac_Room_Text">Deluxe Room</h2>
