...
<body style="margin-top:50px;background: url(images/bg.jpg);">
  <?php
  ...
  <div class="container-fluid">
    ...
    <div style="margin-top: 50px;" class="container">
      <div class="row"><br>
        ...
        <div class="col-sm-4 text-center" style="box-shadow:2px 2px 2px;background-color:darkslategray;"><br>

          <h1 align="center"><b>
              <font style="font-family: 'Libre Baskerville', serif;text-shadow:3px 3px #000;">User Login ?</font>
            </b></h1>
          <img src="images/clipart/login-user-icon.png" class="img-circle" alt="Bird" width="130" height="120">
          <?php echo @$error; ?>
          <form method="post"><br>
