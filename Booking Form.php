...
<body style="margin-top:50px;">
  ...
  include('Menu Bar.php');
  ?>
  <div style="background-color:white;" class="container-fluid text-center" id="primary">
    <!--Primary Id-->
    <h1 style="color: goldenrod;">BOOKING FORM</h1><br>
    <div class="container">
      <div class="row">
        <?php echo @$msg; ?>
          ...
          <div class="col-sm-6">
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-sm-7">
                  <input type="date" min="' + (new Date()).toISOString().substring(0,10) + '" name="cdate" class="form-control" required>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-6">
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-sm-7">
                  <input type="date" min="' + (new Date()).toISOString().substring(0,10) + '" name="codate" class="form-control" required>
                </div>
              </div>
            </div>
          </div>
