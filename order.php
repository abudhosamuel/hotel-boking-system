...
<body style="margin-top:50px;">
  ...
  <div class="container-fluid">
    <!--Primary Id-->
    <h1 style="color:goldenrod" class="text-center text-primary">BOOKING DETAILS</h1><br>
    <div class="container">
      <div class="row">
        <table class="table table-striped table-bordered table-hover table-responsive" style="height:120px;">
          <tr>
            <th>Name</th>
            <th>Email</th>
            <th>Mobile Number</th>
