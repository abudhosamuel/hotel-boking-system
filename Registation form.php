...
<body style="margin-top:50px; background-color:darkslategray">
  <?php
  include('Menu Bar.php');
  ?>
  <div class="container-fluid" style="background-color:darkslategray;color:#000;">
    <!-- Primary Id-->
    <div style="margin-top: 80px;" class="container">
      <div class="row">
        <center>
          <h1 style="background-color:#fff; border-radius:30px;padding:4px;display:inline-block;"><b>
