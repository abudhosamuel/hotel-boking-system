          ...
          <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="item active">
                <img src="images/Luxury/1.jpg" class="thumbnail" alt="img1">
              </div>

              <div class="item">
                <img src="images/Luxury/2.jpg" class="thumbnail" alt="im2">
              </div>

              <div class="item">
                <img src="imageS/Luxury/3.jpg" class="thumbnail" alt="im3">
              </div>

              <div class="item">
                <img src="images/Luxury/4.jpg" class="thumbnail" alt="img4">
              </div>

              <div class="item">
                <img src="images/Luxury/5.jpg" class="thumbnail" alt="img5">
              </div>
            </div>
